...
from models.multihead import MutilHeadAttention
...
def define_ad_attention(in_shape):
    inputs = Input(in_shape)
    #l = keras.layers.Dense(128, activation='relu')(inputs)
    l = keras.layers.Attention()([inputs,inputs])
    l = keras.layers.BatchNormalization()(l)
    l = keras.layers.Dropout(0.3)(l)
    l = keras.layers.Dense(1)(l)
    outputs = keras.layers.BatchNormalization()(l)
    #outputs = keras.layers.Dense(1, activation='sigmoid')(l)
