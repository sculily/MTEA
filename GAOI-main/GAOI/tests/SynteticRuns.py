...
from utils.utils import focal_loss, extract_points, _sod_2, data_plot
...
def run_test(path, **kwargs):
    ...
    for i in range(n_runs):
        ...
        for j in range(n_adv):
            ...
            data_plot(x_train, y_train, new_point=new_sample[0], name=os.path.join(path, f'adv_point_{j}'), train=True)
